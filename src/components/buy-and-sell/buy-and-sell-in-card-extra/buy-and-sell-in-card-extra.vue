<template>
  <div class="transfer-in-wallet-extra">
          ...
          <div class="transfer-in-wallet-extra-input__container">
            ...
            <div class="transfer-in-wallet-extra-input-card__container">
              <div class="row items-center">
                <img
                  src="~assets/card-extra-icon.svg"
                  alt=""
                >
    ...
    <buy-and-sell-in-card-extra-confirmation v-else />
    <div
      @click="checkStep"
...
import BuyAndSellInCardExtraConfirmation
  from 'components/buy-and-sell/buy-and-sell-in-card-extra/buy-and-sell-in-card-extra-confirmation';
import ethCur from 'assets/eth.png';
import btcCur from 'assets/btc.png';
import clinkCur from 'assets/clink.png';

export default {
  name: 'BuyAndSellInCardExtra',
  data: () => ({
    wallets: [
      {
        icon: iconCurrency,
  ...
  components: {
    BuyAndSellInCardExtraConfirmation,
  },
};
</script>
