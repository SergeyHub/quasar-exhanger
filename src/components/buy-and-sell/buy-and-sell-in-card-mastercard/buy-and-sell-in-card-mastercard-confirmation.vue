<template>
  <div class="flex column items-center">
    <div class="buy-and-sell-confirmation-up-title">
      Купить
    </div>
      ...
      <div class="transfer-in-wallet-information__container">
        <div class="transfer-in-wallet-information__content flex row justify-between">
          ...
          >
            ...
            <div class="transfer-in-wallet-information__info-text">
              Bitcoin адрес: кошелек Extra
            </div>
          </div>
        </div>
      </div>
...
import imgMastercard from 'assets/mc_symbol.svg';

export default {
  name: 'BuyAndSellInCardMastercardConfirmation',
  data: () => ({
    curIcon: currency,
    code: '',
    iconMastercard: imgMastercard,
  }),
};
</script>
...
.img-card
  width: 54px
  height: 36px
.buy-and-sell-confirmation-up-title
  margin-top: 45px
