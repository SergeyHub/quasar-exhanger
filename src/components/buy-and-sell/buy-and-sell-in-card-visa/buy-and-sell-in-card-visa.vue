<template>
  <div class="transfer-in-wallet-extra">
    ...
    <buy-and-sell-in-card-visa-confirmation v-else />
    <div
      @click="checkStep"
...
import BuyAndSellInCardVisaConfirmation
  from 'components/buy-and-sell/buy-and-sell-in-card-visa/buy-and-sell-in-card-visa-confirmation';
import ethCur from 'assets/eth.png';
import btcCur from 'assets/btc.png';
import clinkCur from 'assets/clink.png';

export default {
  name: 'BuyAndSellInCardVisa',
  data: () => ({
    wallets: [
      {
        icon: iconCurrency,
  ...
  components: {
    BuyAndSellInCardVisaConfirmation,
  },
};
</script>
