<template>
  <div class="transfer-in-wallet-extra">
    ...
    <transfer-in-fiat-confirmation v-else />
    <div
      @click="checkStep"
...
import TransferInFiatConfirmation
  from 'components/wallets_transfer/transfer-in-fiat/transfer-in-fiat-confirmation';
