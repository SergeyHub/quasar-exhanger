<template>
  <div class="transfer-in-wallet-extra">
    ...
    <transfer-in-card-extra-confirmation v-else />
    <div
      @click="checkStep"
...
import TransferInCardExtraConfirmation
  from 'components/wallets_transfer/transfer-in-card-extra/transfer-in-card-extra-confirmation';

export default {
  name: 'TransferInCardExtra',
  data: () => ({
    wallets: [
      {
        icon: iconCurrency,
  ...
  components: {
    TransferInCardExtraConfirmation,
  },
};
</script>
