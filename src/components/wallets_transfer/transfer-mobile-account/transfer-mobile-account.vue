<template>
  <div class="transfer-in-wallet-extra">
      ...
      <div class="column items-center flex">
        <div class="transfer-in-wallet-extra-select items-center justify-center row">
          <div class="transfer-in-wallet-extra-select__container">
            ...
            <div class="row justify-between transfer-mobile-account__operator">
              <div class="transfer-in-wallet-extra-input__container">
                <div
                  class="transfer-in-wallet-extra-input__title
               transfer-in-wallet-extra-input__title-phone"
                >
                  Введите номер тел
                </div>
                <q-input
                  class="transfer-in-wallet-extra-input__input
                 transfer-in-wallet-extra-input__input-phone"
                  dark
                  borderless
                  v-model="phone"
                  mask="+7 (###) ### ## ##"
              ...
              <div class="transfer-in-wallet-extra-select__container">
                ...
                <div class="transfer-in-wallet-extra-select__select">
                  <q-btn
                    ...
                    class="transfer-in-wallet-extra-select__btn-wallets
            transfer-in-wallet-extra-select__btn
            transfer-in-wallet-extra-select__select-operator"
                  >
                    <div class="flex row justify-center items-center">
                      <img
                        class="transfer-in-wallet-extra-select__btn-icon"
                    ...
                    <q-menu>
                      <q-list class="transfer-in-wallet-extra-select__select__down-panel">
                        ...
                        >
                          <q-item-section @click="operator.icon=item.icon">
                            <div class="flex row">
                              <img
                                :src="item.icon"
                                alt=""
    ...
    <transfer-mobile-account-confirmation v-else />
    <div
      @click="checkStep"
...
import iconBeeline from 'assets/beeline.svg';
...
import TransferMobileAccountConfirmation
  from 'components/wallets_transfer/transfer-mobile-account/transfer-mobile-account-confirmation';
...
export default {
  ...
  components: {
    TransferMobileAccountConfirmation,
  },
};
</script>

<style scoped lang="sass">
.transfer-mobile-account__operator
  margin-top: 27px
.transfer-in-wallet-extra-input__title-phone
