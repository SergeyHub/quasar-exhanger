  ...
  <div class="transfer-in-wallet-extra">
    <div class="items-center">
      ...
      <div
        ...
        v-if="!isConfirmation"
      >
        <div class="transfer-in-wallet-extra__btn">
          <q-radio
            dense
            color="pink-13"
            v-model="requisites"
    ...
    >
      <div class="column items-center flex">
        <div class="transfer-in-wallet-extra-select items-center justify-center row">
          ...
          <div class="transfer-in-bank__requisites">
        ...
        <div class="transfer-in-wallet-extra-input">
          <div class="transfer-in-wallet-extra-input__container">
            ...
            >
              ...
              >
                <div
                  class="transfer-in-wallet-extra-input__patronymic"
                >
                  Если есть
                </div>
              </template>
          ...
          <div class="row justify-between">
            ...
            >
              ...
              <q-input
                ...
                v-model="kpp"
                dark
                class="transfer-in-wallet-extra-input__input-kpp-and-bik"
              />
            </div>
            <div
              class="transfer-in-wallet-extra-input__container
          ...
          <div class="row">
            ...
            >
              ...
              <q-input
                ...
                dark
                class="transfer-in-wallet-extra-input__input-sum"
              >
...
import iconTinkoff from 'assets/tinkoff.svg';
import TransferInBankConfirmation
  from 'components/wallets_transfer/transfer-bank/transfer-in-bank-confirmation';

const stringOptions = [
  { label: 'Тинькофф', icon: iconTinkoff }, { label: 'Приват', icon: iconTinkoff }, { label: 'Альфа', icon: iconTinkoff },
];
